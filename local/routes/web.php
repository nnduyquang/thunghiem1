...
Route::group(['middleware' => ['auth']], function () {
    ...
    //PAGE-TEST
    Route::get('sml_admin/page-test',function(){
        return view('backend.admin.page-test.index');
    })->name('page-test.index');
    Route::get('sml_admin/page-test-create',function(){
        return view('backend.admin.page-test.create');
    })->name('page-test.create');
    Route::get('sml_admin/page-test-edit',function(){
        return view('backend.admin.page-test.edit');
    })->name('page-test.edit');
